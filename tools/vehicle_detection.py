...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str,
                        default='cfgs/carla_models/vehicle_model/pointpillar_vehicle_local.yaml',
                        help='specify the config for demo')
    parser.add_argument('--ckpt', type=str, default='ckpt/pointpillars/vehicle/0121/checkpoint_epoch_70.pth',
...
def main():
    ...
    if args.single_seq:
        seq_folder = args.data_path
        bin_folder = os.path.join(seq_folder, 'vehicle/lidar_bin')
        detection_folder = os.path.join(seq_folder, 'vehicle/detection')
        detection_single_folder(args, cfg, logger, bin_folder, detection_folder)
    else:
